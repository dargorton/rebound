...
public class RotateUtil {
    ...
    public static void setServerRotation(double yaw, double pitch) {
        ...
        Objects.requireNonNull(Backdoor.mc.getNetworkHandler()).sendPacket(new PlayerMoveC2SPacket.LookAndOnGround((float) yaw, (float) pitch, Backdoor.mc.player.isOnGround()));
    }
