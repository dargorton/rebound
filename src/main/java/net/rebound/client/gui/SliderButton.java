...
public class SliderButton extends SliderWidget {
    ...
    public void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        int startSliderColor = new Color(138, 88, 196, 100).getRGB(); // slider
        int endSliderColor  = new Color(138, 88, 196, 100).getRGB();
        ...
        FontAPI.OSANS.drawString(context.getMatrices(),getMessage().getLiteralString(),
